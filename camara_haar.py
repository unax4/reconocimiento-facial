...
class FaceRecognitionApp(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # Inicializar clasificador Haar Cascade para detección facial
        self.face_cascade = cv2.CascadeClassifier(cv2.data.haarcascades + 'haarcascade_frontalface_alt.xml')
        if self.face_cascade.empty():
            QtWidgets.QMessageBox.critical(self, "Error", "No se pudo cargar el clasificador Haar Cascade")
            sys.exit(1)
    ...
    def process_face(self, face_resized):
        # Procesar una imagen de rostro para reconocimiento
        with self.model_lock:
    ...
    def smooth_prediction(self, current_label, current_confidence):
        # Suavizar las predicciones para evitar cambios bruscos
    ...
    def camera_loop(self):
        ...
        try:
            ...
            self.running = True
            frame_count = 0
            detection_interval = 5  # Detectar cada 5 frames
            ...
            while self.running:
                ...
                # Convertir frame a QImage para visualización
    ...
    def submit_new_subject(self):
        # Enviar un nuevo sujeto a la base de datos
    ...
    def closeEvent(self, event):
        # Cerrar la aplicación limpiando recursos
        self.running = False
